...
echo
echo "Ubuntu 18.04 LTS initramfs created at: $(realpath --relative-to="${root}" "${initramfs}")"
echo "Ubuntu 18.04 LTS kernel created at: $(realpath --relative-to="${root}" "${kernel}")"
