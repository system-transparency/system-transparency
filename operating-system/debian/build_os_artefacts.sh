...
echo ""
docker run --env DEBOS_USER_ID="$(id -u)" --env DEBOS_GROUP_ID="$(id -g)" --cap-add=SYS_ADMIN --security-opt apparmor:unconfined -it --volume "${root}:/system-transparency-root:z" ${docker_image}
