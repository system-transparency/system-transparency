...
mem=${ST_QEMU_MEM}
firmware="${root}/out/stboot-installation/coreboot-payload/stboot_coreboot_installation.rom"
image="${root}/out/stboot-installation/coreboot-payload/stboot_coreboot_installation.img"
